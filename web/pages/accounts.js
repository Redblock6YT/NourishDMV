                    ...
                    anime({
                        ...
                        complete: function (anim) {
                            if (actionType == "Sign In") {
                                ...
                                axios({
                                    url: 'http://nourishapi.rygb.tech:8445/requestSignIn?email=' + document.getElementById("email").value + '&password=' + hashedpassword,
                                    method: 'get',
                                }).then((result) => {
                                ...
                                const hashedpassword = crypto.createHash('sha256').update(document.getElementById("password").value).digest('hex');
                                axios({
                                    url: "http://nourishapi.rygb.tech:8445/createAccount",
                                    method: 'post',
                                    data: {
